          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-16">
            {allProducts.map(product => (
              <button
                ...
                className={`flex flex-col items-center justify-center p-4 rounded-xl transition-all duration-300 w-28 h-28 md:w-40 md:h-40 border-2 ${activeProductKey === product.key
              ...
              >
                ...
                <span className={`text-xs md:text-sm text-center leading-tight font-semibold ${activeProductKey === product.key ? 'text-[#00994d]' : 'text-gray-600'
                  }`}>
                  {product.name}
                </span>
              </button>
